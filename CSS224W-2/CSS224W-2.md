...
<image src=1.png align=center></image>
...
+ Kronecker图:
   ...
   <image src=4.png width=80% height=80% align=center/>
   ...
   <image src=5.png width=70% height=70% align=center/>
+ 随机Kronecker图(Stochastic Kronecker Graphs)
   ...
   <image src=6.png width=70% height=70% align=center/>
